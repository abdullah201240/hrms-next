  ...
  return (
    <div className="dash space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        {/* Attendance Trend */}
        <Card className="lg:col-span-5 rounded-2xl border border-slate-200/50 bg-white dark:border-slate-800/40 dark:bg-[#121826]">
          <CardContent className="flex h-full flex-col justify-between p-5">
            ...
            <div className="grid grid-cols-1 items-center gap-4 sm:grid-cols-4">
              ...
              <div className="flex flex-col justify-center rounded-xl border border-sky-100/80 bg-sky-50/60 p-3.5 dark:border-sky-900/30 dark:bg-sky-950/25 sm:col-span-1">
                <div className="mb-2 flex size-7 items-center justify-center rounded-lg border border-sky-200/70 bg-white text-sky-600 dark:border-sky-800 dark:bg-slate-900 dark:text-sky-400">
        ...
        {/* Action Center */}
        <Card className="lg:col-span-4 rounded-2xl border border-slate-200/50 bg-white dark:border-slate-800/40 dark:bg-[#121826]">
          <CardContent className="flex h-full flex-col justify-between p-5">
            <div className="flex items-center justify-between gap-2 pb-3">
              <div className="flex items-center gap-2.5">
                <div className="flex size-9 items-center justify-center rounded-xl border border-amber-200/60 bg-amber-50 text-amber-600 dark:border-amber-500/30 dark:bg-amber-950/50 dark:text-amber-400">
        ...
        <Card className="lg:col-span-3 rounded-2xl border border-slate-200/50 bg-white dark:border-slate-800/40 dark:bg-[#121826]">
          <CardContent className="flex h-full flex-col justify-between p-5">
            <div className="flex items-center justify-between gap-2 pb-3">
              <div className="flex items-center gap-2.5">
                <div className="flex size-9 items-center justify-center rounded-xl border border-sky-200/60 bg-sky-50 text-sky-600 dark:border-sky-500/30 dark:bg-sky-950/50 dark:text-sky-400">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
          ...
          <CardContent className="p-5">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                <thead>
                  <tr className="border-b border-slate-100 text-slate-500 dark:border-slate-800/40 dark:text-slate-400">
        ...
        <div className="flex flex-col justify-between gap-4 lg:col-span-3">
          ...
          <Card className="flex-1 rounded-2xl border border-slate-200/50 bg-white dark:border-slate-800/40 dark:bg-[#121826]">
            <CardContent className="p-5">
              <div className="flex items-center justify-between gap-2 pb-4">
                <div className="flex items-center gap-2.5">
                  <div className="flex size-9 items-center justify-center rounded-xl border border-sky-200/60 bg-sky-50 text-sky-600 dark:border-sky-500/30 dark:bg-sky-950/50 dark:text-sky-400">
          ...
          <Card className="relative overflow-hidden rounded-2xl border border-slate-800/40 bg-slate-900 text-white dark:bg-[#0f172a]">
            ...
            <CardContent className="relative z-10 flex items-center justify-between gap-3 p-5">
              <div className="space-y-1">
                ...
                <div className="pt-2">
                  <Button
                    size="sm"
                    className="h-8 rounded-xl bg-white px-3 text-xs font-semibold text-slate-900 hover:bg-slate-100"

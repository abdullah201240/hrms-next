...
const STYLES: Record<string, string> = {
  ...
  Applicable: "bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400",
  Claimed: "bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400",
  ...
  Scheduled: "bg-sky-50 text-sky-700 dark:bg-sky-950 dark:text-sky-400",
  Sent: "bg-sky-50 text-sky-700 dark:bg-sky-950 dark:text-sky-400",
  "Under Review": "bg-sky-50 text-sky-700 dark:bg-sky-950 dark:text-sky-400",
  "In Process": "bg-sky-50 text-sky-700 dark:bg-sky-950 dark:text-sky-400",
  Withheld: "bg-amber-50 text-amber-700 dark:bg-amber-950 dark:text-amber-400",
  "Not Paid": "bg-zinc-50 text-zinc-600 dark:bg-zinc-900 dark:text-zinc-400",

...
export function StatCard({
  ...
  return (
    <Card
      className={`group relative overflow-hidden rounded-2xl border ${palette.cardBorder} shadow-[0_2px_8px_rgba(0,0,0,0.02)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.06)] transition-all ${palette.cardBg}`}
    >

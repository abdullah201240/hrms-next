...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "group/avatar relative flex size-8 shrink-0 select-none rounded-full overflow-hidden after:rounded-full after:absolute after:inset-0 after:border after:border-black/5 dark:after:border-white/10 data-[size=lg]:size-10 data-[size=sm]:size-6",
        className
      )}
      {...props}
    />
